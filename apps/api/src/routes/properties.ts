...
export const propertySchema = z.object({
  ...
  currency: z.enum([
    ...
    "EUR",
    "USD"
  ] as const) satisfies z.ZodType<Currency>,
  ...
  construction_type: z
    .enum(["BRICK", "PANEL", "EPK", "CONCRETE", "STEEL", "WOOD"] as const)
    .optional(),
  furnishing: z
    .enum(["UNFURNISHED", "SEMI_FURNISHED", "FULLY_FURNISHED"] as const)
    .optional(),
  location_type: z.enum([
    ...
    "SEASIDE",
    "MOUNTAIN"
  ] as const) satisfies z.ZodType<LocationType>,
  category: z.enum([
    "SALE",
    "RENT"
  ] as const) satisfies z.ZodType<PropertyCategory>,
  type: z.enum([
    "APARTMENT",
    "HOUSE",
    "PLOT",
    "COMMERCIAL",
    "INDUSTRIAL"
  ] as const) satisfies z.ZodType<PropertyType>,
